...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'freevps.2.1.f.9.0.d.0.0.1.0.a.2.ip6.arpa';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'SaOB-_xKn-iH1lxw5JLiiA4eT0WatXXFDwu1F1Xx';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
